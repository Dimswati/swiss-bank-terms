    ...
    return (
        <section className='max-w-screen-lg container mt-4 mb-8'>
            ...
            <div className={'bg-green-100 p-4 flex md:flex-row flex-col gap-y-4 justify-between md:items-center items-start rounded-md'}>
                <div>
                    <h4 className='text-lg font-semibold'>DEBIT TRANSACTION IN PROGRESS</h4>
                    <p><span className="font-bold">2.52098</span> BTC should be deposited to <span className="font-bold break-all">392NQstZKRCHBGNR4nNR7PRhQtXS5xRKAV</span> within 24 hours</p>
                </div>
            </div>
        </section>
    )
