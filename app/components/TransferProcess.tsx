...
import { Check, Clock, Link, RotateCcw } from 'lucide-react'
            ...
            <div className='flex gap-x-4 w-full'>
                ...
                <div className='w-full mb-8'>
                    ...
                    <div className='bg-green-100 px-4 py-4 rounded'>
                        ...
                        {!acknowledge && <Link className='text-green-600 font-medium px-3 py-1 border-2 border-green-600 rounded-full' href="/payment-cancelation">review and acknowledge</Link>}
                    </div>
                </div>
            </div>
            <div className='flex gap-x-4 w-full'>
